...
document.addEventListener('keydown', function(e) {
    ...
    // Ctrl+C - Copy (optional - can be restrictive)
...
// When DevTools is detected, show warning
globalThis.addEventListener('devtoolschange', function(e) {
    if (e.detail.isOpen) {
        document.body.innerHTML = '<div style="display:flex;justify-content:center;align-items:center;height:100vh;background:#1a1a2e;color:#fff;font-family:Poppins,sans-serif;text-align:center;"><div><h1 style="font-size:3rem;margin-bottom:1rem;">⚠️ Developer Tools Detected</h1><p style="font-size:1.2rem;">Please close Developer Tools to view this website.</p></div></div>';
    }
});

// Console warning message
console.log('%c⚠️ WARNING!', 'color: red; font-size: 50px; font-weight: bold;');
console.log('%cThis is a protected website. Copying source code is not allowed.', 'color: #333; font-size: 18px;');
console.log('%c© Suprio Pramanik Emon - All Rights Reserved', 'color: #666; font-size: 14px;');